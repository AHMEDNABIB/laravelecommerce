                        ...
                        <table class="table table-wishlist">
                            ...
                            <tbody>
                                 ...
                                 @foreach(session('cart') as $id => $details)
                                    ...
                                    <td class="image product-thumbnail"><img src="{{url('image/products/',$details['image'])}}"  width="100" height="100" class="img-responsive"/></td>
                                    <td class="product-des product-name">
                                        <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="shop-product-right.html">{{ $details['name'] }}</h6>
                                    ...
                                    <td >
                                        {{-- <div class="detail-extralink mr-15">
                                            <div class="detail-qty border radius">
                                                ...
                                                <input type="text" name="quantity" class="qty-val quantity update-cart" value="{{ $details['quantity'] }}" min="1">
