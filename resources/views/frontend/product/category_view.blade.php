                    ...
                    <div class="sidebar-widget widget-category-2 mb-30">
                        ...
                        <ul>
                           @foreach($categories as $category)
                                ...
                                <li>
                                    <a href="{{ url('product/category/'.$category->id.'/'.$category->slug) }}"> <img class="default-img"  src="{{url('image/categories/',$category->image)}}"  alt="" />{{ $category->name }}</a><span class="count">{{ count($products) }}</span>
                                </li>
                            @endforeach 
                        </ul>
                    </div>
